...
| `validate-architecture-refactor.sh` | PostToolUse (Write/Edit) | C# changes under `Assets/_Project/` | Advises on Domain/Application boundary leaks, ObservableCollections public API leaks, and ZLinq misuse during refactors |
