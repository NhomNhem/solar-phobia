...
namespace SolarPhobia.Application.Services.Objective
{
    public class ShrineObjectiveService : IShrineObjectiveService
    {
        ...
        public ShrineObjectiveService(IPhaseStateMachine phaseStateMachine, float triggerRadius = DefaultTriggerRadius, float debounceWindowSec = DefaultDebounceWindowSec)
        {
