using SolarPhobia.Application.Features.Day.UseCases;
using SolarPhobia.Application.Features.Phase.Flow.UseCases;
using SolarPhobia.Application.Features.Shrines.UseCases;
