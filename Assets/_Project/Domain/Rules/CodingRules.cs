...
namespace SolarPhobia.Domain.Rules
{
    /// <summary>
    /// Common coding patterns and gotchas for Solar Phobia.
    /// </summary>
    public static class CodingRules
    {
        ...
        public static class RequiredUsings
        {
            ...
            public const string Messages = "using SolarPhobia.Application.Messages; // for PhaseChangedEvent, DayStartEvent, etc.";
